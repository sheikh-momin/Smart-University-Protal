    ...
    <div className="bg-zinc-300">
      ...
      <div className="drawer">
        ...
        <div className="drawer-content w-full flex justify-center">
          <StudentClearenceComponent></StudentClearenceComponent>
        </div>
                ...
                <ul class="space-y-2">
                  ...
                  <li>
                    <Link href="/employeeDashboard/profile" class="flex items-center p-2 text-base font-normal text-black hover:text-white rounded-lg dark:text-black hover:bg-black dark:hover:bg-gray-700">
                      <ImProfile size="23px" className="text-amber-400 ml-2"></ImProfile>
                  ...
                  <li>
                    <Link href="/employeeDashboard/studentDue" class="flex items-center p-2 text-base font-normal text-black hover:text-white rounded-lg dark:text-black hover:bg-black dark:hover:bg-gray-700">
                      <CgCalendarDue size="25px" className="text-amber-400 ml-2"></CgCalendarDue>
                      <span class="flex-1 ml-2 whitespace-nowrap font-bold">Student Due</span>

                    </Link>
                  </li>
                  <li>
                    <Link href="/employeeDashboard/studentClearence" class="flex items-center p-2 text-base font-normal text-black hover:text-white rounded-lg dark:text-black hover:bg-black dark:hover:bg-gray-700">
                      <MdOutlineRequestPage size="25px" className="text-amber-400 ml-2"></MdOutlineRequestPage>
                      <span class="flex-1 ml-2 whitespace-nowrap font-bold">Student Clearance</span>
