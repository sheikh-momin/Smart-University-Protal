      ...
      <div className="md:grid grid-cols-12 gap-4 my-20">
        ...
        <div className="col-span-9">
          <div className="border-y border-slate-400 py-2">
            <h1 className="text-center text-teal-700 md:text-3xl font-bold italic font-serif">Department of Business Administration</h1>
          </div>
          <div className="mx_5 my-5 text-lg">
