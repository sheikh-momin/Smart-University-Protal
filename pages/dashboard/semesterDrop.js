...
import SemesterDropComponent from "../../components/Dashboard/SemesterDropComponent";
    ...
    <div className="bg-[#d4d4d8] pb-80 ">
      <div className="navbar bg-gradient-to-r from-blue-900   to-cyan-500">
        ...
        <div className="navbar-center">
          <Link
            href="/dashboard"
            className="btn btn-ghost normal-case text-white  md:text-2xl"
          >
      ...
      <div className="drawer">
        ...
        <div className="drawer-content w-full flex justify-center">
          <SemesterDropComponent></SemesterDropComponent>
        </div>
                ...
                <ul class="space-y-2">
                  <li className="">
                    ...
                    >
                      <svg
                        aria-hidden="true"
                        class="w-6 h-6 ml-1 text-amber-400 transition duration-75 dark:text-black group-hover:text-gray-900 dark:group-hover:text-white"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg"
                      >
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span
                        ...
                        class="flex-1 ml-3 whitespace-nowrap text-red-500 font-bold"
                      >
                        log Out
                      </span>
                    </Link>
