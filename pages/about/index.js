      ...
      <div className="bg-zinc-300">
        ...
        <div className="flex mt-10">
          ...
          <div className="w-2/3" id="about">
            ...
            <h2 className="text-black text-md mt-3">
            ...
            <h5 className="text-black text-xl mt-10 mb-20"> Funded by organisation of Dreamers Cooperation</h5>
