  ...
  return (
    <div>
      ...
      <div className="bg-teal-700">
        ...
        <div>
          <img src="https://wallpaperaccess.com/full/1209573.jpg" className="w-full h-3/6 pt-5" />
        </div>
        ...
        <div className="flex mt-10">
          ...
          <div className="w-2/3">
            ...
            <p className="text-white text-md mt-3">Islamic University of Technology (Dreamers University) is an educational
              and research institution in Bangladesh run and funded by the Organisation of Islamic Cooperation (OIC).The main objective of Dreamers University is to contribute in developing the human resources of the member states of the OIC, particularly in the fields of engineering, technology and technical education. Dreamers University receives direct endowment from OIC member countries and offers scholarships to its students in the form of free tuition, boarding, lodging and medicare. The aesthetic campus was designed by Turkish architect Pamir Mehmet, an MIT graduate</p>

            <h2 className="text-white text-4xl mt-12" >Objective of Dreamers University</h2>
            <p className="text-white text-md mt-3">The Islamic University of Technology is basically an educational and research institution. The main objective of the University is to help generally in human resources development in member states of the OIC, particularly in different fields of engineering, technology and technical education.</p>

            <ul>
              <li className="text-white mt-4">1. Provide instruction in engineering, technology and technical and vocational education and in such branches of learning connected with the above fields as per requirement of the Member States and as approved the Conference, and in particular, train instructors, technicians in technologies needed in the Member States and to upgrade the mid level and lower level manpower to international standards.</li>
              <li className="text-white mt-4">2. Conduct, promote and guide research in engineering, in industrial and technological fields and in technical and vocational education to the benefits of the Member States of the OIC.</li>
              <li className="text-white mt-4">3. Hold examination and grant and confer certificates, degrees, diplomas and other academic distinctions on persons who have pursued courses of study provided by the University and have passed the examinations of the University under such conditions as may be prescribed by the academic rules and regulations of the University.</li>
              <li className="text-white mt-4">4. May confer other academic distinctions on persons of high eminence of the Member States with the approval of the general assembly on the recommendation of the Board.</li>
              <li className="text-white mt-4">5. Promote technical cooperation, exchange technical know-how and disseminate basic information in the field of human resource development through short and special courses, seminars, workshops and publications.</li>
              <li className="text-white mt-4">6. Ensure coordination between the objective of the University with other national and regional institutions of the Islamic Countries as well as with international institutions.</li>
              <li className="text-white mt-4">7. Undertake advisory and consultancy services for government, International Bodies and foundations or allied organizations.</li>
              <li className="text-white mt-4">8. Participate in the meetings of commissions and committees established by the Conference with appropriate background and technical papers.</li>
            </ul>

            <h3 className="text-white text-4xl mt-12"> History of Dreamers University</h3>
            <p className="text-white text-md mt-3">“Islamic University of Technology”​ after fulfilling appropriate procedural requirements.”​Islamic University of Technology at Dhaka, Bangladesh commonly known as Dreamers University is a subsidiary organ of the Organisation of the Islamic Conference (OIC), representing fifty seven member countries from Asia, Africa, Europe and South America.
            </p>
