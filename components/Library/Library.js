            ...
            <div className='flex bg-zinc-300 justify-center '>
                ...
                <div className='mt-10 '>
                    ...
                    <div class="grid md:grid-cols-2 grid-cols-1 gap-5  mt-10">
                        <div className="card card-compact md:w-96 md:h-60 bg-base-100 shadow-xl">
                    ...
                    <div>
                        ...
                        <div className="card card-compact w-96 md:h-60 bg-base-100 shadow-xl">
                    ...
                    <div>
                        ...
                        <div className="card card-compact md:w-96 md:h-60 bg-base-100 shadow-xl mt-5">
