...
const AlumniCard = () => {
  ...
  <div class="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-5">
    ...
    <div class="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-2xl hover:shadow-black/30">
      <div class="h-96 w-72">
        <img class="h-full w-full object-cover transition-transform duration-500 group-hover:rotate-3 group-hover:scale-125" src="https://scontent.fdac99-1.fna.fbcdn.net/v/t39.30808-6/270220737_4235138403258540_2300092673988259396_n.jpg?_nc_cat=106&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=KxoI21sFJH0AX_EgbGG&_nc_oc=AQnRCTtGnmxUsZ7sC4q2-FdwIEBBWdJYwqULgeASDpehVtIzmkzwUiYNjauApiKt26s&_nc_ht=scontent.fdac99-1.fna&oh=00_AfAal5BIHSaKC01eHXl4KQ2XAwdHuZG9CYnV-wUFYydmRA&oe=63F94803" alt="" />
      </div>
      <div class="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black group-hover:from-black/70 group-hover:via-black/60 group-hover:to-black/70"></div>
      <div class="absolute inset-0 flex translate-xy-[50%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
        <h1 class="font-dmserif text-3xl font-bold text-white mt-56">Limu Hasan</h1>
        <p class="mb-3 text-lg italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis dolore adipisci placeat.</p>
        <button class="rounded-full bg-neutral-900 py-2 px-3.5 font-com text-sm capitalize text-white shadow shadow-black/60">See More</button>
      </div>
    </div>
