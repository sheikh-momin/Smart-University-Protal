    ...
    <div>
      ...
      <div className="mx-5 my-5 text-lg">
        ...
        <h3>
          ...
          Knowledge, Paragraph writing. Analytical Ability (for BBA), Physics,
          Chemistry & Mathematics (for CSE & EEE), Writing Skill (for LLB),
          Reading comprehension and Composition (for English).
        </h3>
      </div>
      ...
      <div className="mx-5 my-5 text-lg">
        ...
        <h3>
          ...
          <br /> <br />
          Course Waiver/Exemption for Graduate Students <br /> <br />A graduate
          student with undergraduate degree from Eastern University may get
          waiver or exemption of courses to a maximum of 50% of the total
          credits required for the degree. A graduate student with undergraduate
          degree from other universities may get waiver or exemption of courses
          to a maximum of 35% of the total credits required for the degree. In
          exceptional cases, the limit may be raised to 40% by the appropriate
          authority. Transcripts and other supporting documents must be
          submitted with the application for exemption/waiver. <br /> <br />
          ...
          least up to 85% with the contents of the corresponding course at DU.
        </h3>
      </div>
      ...
      <div className="mx-5 my-5 text-lg">
        ...
        <h3>
          ...
          E-mail: admission@dreamers.edu.bd
        </h3>
      </div>
    </div>
  );
