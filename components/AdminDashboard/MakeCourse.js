      ...
      <form onSubmit={handleSubmit(handleSignUp)}>
        <div className="container mx-auto lg:flex justify-center gap-10">
          <div className="form-control w-full max-w-xs my-5 container">
            <select
              className="select select-bordered w-full max-w-xs md:mt-5"
        ...
        <div className="grid lg:grid-cols-5 md:grid-cols-5 gap-4 grid-cols-1">
          <div className="form-control w-full max-w-xs">
            ...
            />
            {errors.courseName2 && (
              <p className="text-red-500">{errors.courseName2.message}</p>
            )}
          </div>
          <div className="form-control w-full max-w-xs">
            <label className="label">
            ...
            <input
              type="text"
              {...register("courseCode2", {
                required: "Name is Required",
              })}
              className="input input-bordered w-full max-w-xs"
            />
            {errors.courseCode2 && (
              <p className="text-red-500">{errors.courseCode2.message}</p>
            )}
          </div>
          <div className="form-control w-full max-w-xs">
            <label className="label">
            ...
            <input
              type="text"
              {...register("courseCredit2", {
                required: "Name is Required",
              })}
              className="input input-bordered w-full max-w-xs"
            />
            {errors.courseCredit2 && (
              <p className="text-red-500">{errors.courseCredit2.message}</p>
            )}
          </div>
          <div className="form-control w-full max-w-xs">
            <label className="label">
            ...
            <input
              type="text"
              {...register("courseSection2", {
                required: "Name is Required",
              })}
              className="input input-bordered w-full max-w-xs"
            />
            {errors.courseSection2 && (
              <p className="text-red-500">{errors.courseSection2.message}</p>
            )}
          </div>
          <div className="form-control w-full max-w-xs">
            <label className="label">
            ...
            <input
              type="text"
              {...register("courseenroll2", {
                required: "Name is Required",
              })}
              className="input input-bordered w-full max-w-xs"
            />
            {errors.courseenroll && (
              <p className="text-red-500">{errors.courseenroll.message}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-5 md:grid-cols-5 gap-4 grid-cols-1">
          <div className="form-control w-full max-w-xs">
            ...
            <input
              type="text"
              {...register("courseName3", {
                required: "Name is Required",
              })}
              className="input input-bordered w-full max-w-xs"
            />
            {errors.courseName3 && (
              <p className="text-red-500">{errors.courseName3.message}</p>
            )}
          </div>
          <div className="form-control w-full max-w-xs">
            <label className="label">
            ...
            <input
              type="text"
              {...register("courseCode3", {
                required: "Name is Required",
              })}
              className="input input-bordered w-full max-w-xs"
            />
            {errors.courseCode3 && (
              <p className="text-red-500">{errors.courseCode3.message}</p>
            )}
          </div>
          <div className="form-control w-full max-w-xs">
            <label className="label">
            ...
            <input
              type="text"
              {...register("courseCredit3", {
                required: "Name is Required",
              })}
              className="input input-bordered w-full max-w-xs"
            />
            {errors.courseCredit3 && (
              <p className="text-red-500">{errors.courseCredit3.message}</p>
            )}
          </div>
          <div className="form-control w-full max-w-xs">
            <label className="label">
            ...
            <input
              type="text"
              {...register("courseSection3", {
                required: "Name is Required",
              })}
              className="input input-bordered w-full max-w-xs"
            />
            {errors.courseSection3 && (
              <p className="text-red-500">{errors.courseSection3.message}</p>
            )}
          </div>
          <div className="form-control w-full max-w-xs">
            <label className="label">
            ...
            <input
              type="text"
              {...register("courseenroll3", {
                required: "Name is Required",
              })}
              className="input input-bordered w-full max-w-xs"
            />
            {errors.courseenroll3 && (
              <p className="text-red-500">{errors.courseenroll3.message}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-5 md:grid-cols-5 gap-4 grid-cols-1">
          <div className="form-control w-full max-w-xs">
            ...
            <input
              type="text"
              {...register("courseName4", {
                required: "Name is Required",
              })}
              className="input input-bordered w-full max-w-xs"
            />
            {errors.courseName4 && (
              <p className="text-red-500">{errors.courseName4.message}</p>
            )}
          </div>
          <div className="form-control w-full max-w-xs">
            <label className="label">
            ...
            <input
              type="text"
              {...register("courseCode4", {
                required: "Name is Required",
              })}
              className="input input-bordered w-full max-w-xs"
            />
            {errors.courseCode4 && (
              <p className="text-red-500">{errors.courseCode4.message}</p>
            )}
          </div>
          <div className="form-control w-full max-w-xs">
            <label className="label">
            ...
            <input
              type="text"
              {...register("courseCredit4", {
                required: "Name is Required",
              })}
              className="input input-bordered w-full max-w-xs"
            />
            {errors.courseCredit4 && (
              <p className="text-red-500">{errors.courseCredit4.message}</p>
            )}
          </div>
          <div className="form-control w-full max-w-xs">
            <label className="label">
            ...
            <input
              type="text"
              {...register("courseSection4", {
                required: "Name is Required",
              })}
              className="input input-bordered w-full max-w-xs"
            />
            {errors.courseSection4 && (
              <p className="text-red-500">{errors.courseSection4.message}</p>
            )}
          </div>
          <div className="form-control w-full max-w-xs">
            <label className="label">
            ...
            <input
              type="text"
              {...register("courseenroll4", {
                required: "Name is Required",
              })}
              className="input input-bordered w-full max-w-xs"
            />
            {errors.courseenroll4 && (
              <p className="text-red-500">{errors.courseenroll4.message}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-5 md:grid-cols-5 gap-4 grid-cols-1">
          <div className="form-control w-full max-w-xs">
            ...
            <input
              type="text"
              {...register("courseName5", {
                required: "Name is Required",
              })}
              className="input input-bordered w-full max-w-xs"
            />
            {errors.courseName5 && (
              <p className="text-red-500">{errors.courseName5.message}</p>
            )}
          </div>
          <div className="form-control w-full max-w-xs">
            <label className="label">
            ...
            <input
              type="text"
              {...register("courseCode5", {
                required: "Name is Required",
              })}
              className="input input-bordered w-full max-w-xs"
            />
            {errors.courseCode5 && (
              <p className="text-red-500">{errors.courseCode5.message}</p>
            )}
          </div>
          <div className="form-control w-full max-w-xs">
            <label className="label">
            ...
            <input
              type="text"
              {...register("courseCredit5", {
                required: "Name is Required",
              })}
              className="input input-bordered w-full max-w-xs"
            />
            {errors.courseCredit5 && (
              <p className="text-red-500">{errors.courseCredit5.message}</p>
            )}
          </div>
          <div className="form-control w-full max-w-xs">
            <label className="label">
            ...
            <input
              type="text"
              {...register("courseSection5", {
                required: "Name is Required",
              })}
              className="input input-bordered w-full max-w-xs"
            />
            {errors.courseSection5 && (
              <p className="text-red-500">{errors.courseSection5.message}</p>
            )}
          </div>
          <div className="form-control w-full max-w-xs">
            <label className="label">
            ...
            <input
              type="text"
              {...register("courseenroll5", {
                required: "Name is Required",
              })}
              className="input input-bordered w-full max-w-xs"
            />
            {errors.courseenroll5 && (
              <p className="text-red-500">{errors.courseenroll5.message}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-5 md:grid-cols-5 gap-4 grid-cols-1">
          <div className="form-control w-full max-w-xs">
            ...
            <input
              type="text"
              {...register("courseName6", {
                required: "Name is Required",
              })}
              className="input input-bordered w-full max-w-xs"
            />
            {errors.courseName6 && (
              <p className="text-red-500">{errors.courseName6.message}</p>
            )}
          </div>
          <div className="form-control w-full max-w-xs">
            <label className="label">
            ...
            <input
              type="text"
              {...register("courseCode6", {
                required: "Name is Required",
              })}
              className="input input-bordered w-full max-w-xs"
            />
            {errors.courseCode6 && (
              <p className="text-red-500">{errors.courseCode6.message}</p>
            )}
          </div>
          <div className="form-control w-full max-w-xs">
            <label className="label">
            ...
            <input
              type="text"
              {...register("courseCredit6", {
                required: "Name is Required",
              })}
              className="input input-bordered w-full max-w-xs"
            />
            {errors.courseCredit6 && (
              <p className="text-red-500">{errors.courseCredit6.message}</p>
            )}
          </div>
          <div className="form-control w-full max-w-xs">
            <label className="label">
            ...
            <input
              type="text"
              {...register("courseSection6", {
                required: "Name is Required",
              })}
              className="input input-bordered w-full max-w-xs"
            />
            {errors.courseSection6 && (
              <p className="text-red-500">{errors.courseSection6.message}</p>
            )}
          </div>
          <div className="form-control w-full max-w-xs">
            <label className="label">
            ...
            <input
              type="text"
              {...register("courseenroll6", {
                required: "Name is Required",
              })}
              className="input input-bordered w-full max-w-xs"
            />
            {errors.courseenroll6 && (
              <p className="text-red-500">{errors.courseenroll6.message}</p>
            )}
          </div>
        </div>
