        ...
        <div className="drawer">
          ...
          <div className="drawer-content">
            <h1 className="text-4xl font-semibold text-center mt-6 mb-4">
              Taken Course for test{" "}
            </h1>
          </div>
          <div className="drawer-side">
            <label htmlFor="my-drawer" className="drawer-overlay"></label>
            <ul className="menu p-4 w-80 bg-gradient-to-r from-[#43cea2]  to-[#185a9d] text-white">
              ...
              <aside class="w-64" aria-label="Sidebar">
                <div class="px-3 py-4 overflow-y-auto rounded bg-transparent dark:bg-gray-800">
                  <ul class="space-y-2">
                    ...
                    <li>
                      <Link
                        href="admindashboard/makecourse"
                        class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
                      >
                        <svg
                          aria-hidden="true"
                    ...
                    <li>
                      <Link
                        href="admindashboard/showallcourse"
                        class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
                      >
                        <svg
                          aria-hidden="true"
                    ...
                    <li>
                      <Link
                        href="admindashboard/showallstudent"
                        class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
                      >
                        <svg
                          aria-hidden="true"
                    ...
                    <li>
                      <Link
                        href="admindashboard/showallteacher"
                        class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
                      >
                        <svg
                          aria-hidden="true"
                    ...
                    <li>
                      <Link
                        href="admindashboard/adminnotice"
                        class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
                      >
                        <svg
                          aria-hidden="true"
