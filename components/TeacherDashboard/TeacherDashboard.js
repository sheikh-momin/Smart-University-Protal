  ...
  return (
    <div className="bg-gradient-to-br from-indigo-300 via-purple-300 to-blue-400 ">
      <div className="relative w-full ">
        <div className="absolute top-16 right-24 w-20 h-20 bg-gradient-to-tr from-indigo-200 via-purple-300 to-blue-500  animate-pulse"></div>
              ...
              <aside class="w-64" aria-label="Sidebar">
                <div class="px-3 py-4 overflow-y-auto rounded bg-transparent dark:bg-gray-800">
                  <ul class="space-y-2">
                    ...
                    <li>
                      <Link
                        href="/teacherdashboard/teacherProfile"
                        class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
                      >
                    ...
                    <li>
                      <Link
                        href="/teacherdashboard/teacherCourse"
                        class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
                      >
                    ...
                    <li>
                      <Link
                        href="/teacherdashboard/liveResult"
                        class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
                      >
                    ...
                    <li>
                      <Link
                        href="/teacherdashboard/dropList"
                        class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
                      >
                        <svg
                          aria-hidden="true"
                    ...
                    <li>
                      <Link
                        href="/teacherdashboard/registeredcourse"
                        class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
                      >
