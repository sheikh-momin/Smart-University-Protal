        ...
        <div className="mt-10">
          <form className="bg-zinc-200 rounded-lg">
            ...
            <div className="flex flex-col w-full border-opacity-50">
              <div className="grid h-20 card bg-base-300 rounded-box place-items-center">
                <div>
                  <a className="link link-primary">
                    প্রধানমন্ত্রী গবেষণা ও উচ্চ শিক্ষা সহায়তা তহবিলের আওতায়
                    পিএইচডি বৃত্তি বিজ্ঞপ্তি
                  </a>
                </div>
              </div>
              ...
              <div className="grid h-20 card bg-base-300 rounded-box place-items-center">
                <a className="link link-primary">
                  পবিত্র শব-ই-মেরাজ উপলক্ষে ছুটির বিজ্ঞপ্তি
                </a>
              </div>
            </div>
            <div className="divider"></div>
            <div className="grid h-20 card bg-base-300 rounded-box place-items-center">
              <a className="link link-primary">
                Admission Notice of Professional Master's in Japanese Studies
                (PMJS)
              </a>
            </div>
