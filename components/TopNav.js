  ...
  return (
    <div>
      <div class="flex flex-row gap-3">
        ...
        <div className="basis-7/12 text-teal-800 font-bold">
          7 Th convocation Registration||Faculty And Department || Alumni ||
          Career ||Hall || Job Placement
        </div>
        <div className="">
          <div className="flex">
            <Link
              href="/youtube"
              class="flex items-center text-base font-normal text-white rounded-lg dark:text-black hover:bg-blue dark:hover:bg-gray-700"
            >
